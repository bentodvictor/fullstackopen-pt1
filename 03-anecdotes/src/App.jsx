...
const App = () => {
  ...
  return (
    <div>
      <Anecdote title="Anecdote of the day" body={anecdotes[selected]} vote={points[selected]} />
      <Button handleClick={handleVote} text="vote" />
      <Button handleClick={handleClick} text="next anecdotes" />
      <Anecdote title="Anecdote with most votes" body={anecdotes[mostVoted]} vote={points[mostVoted]} />
    </div>
  )
}
